...
N.A.T.O.W to gra czołgami bazująca na scorched earth (także xscorch) w
technologii 3D OpenGL. Celem jest niszczenie innych czołgów i
generalnie wszystkiego co się rusza i nie rusza. (TODO pokazuje, że
jeszcze trochę trzeba poczekać na maksymalną grywalność)
